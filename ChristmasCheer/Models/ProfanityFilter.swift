...
private let EnglishProfanityList: [String] = [
    "ahole",
    "anus",
    "ash0le",
    "ash0les",
...
private let SpanishProfanityList: [String] = [
    "puta",
    "pendeja",
    "culo",
    "pito",
...
private let LoganAdditions: [String] = [
    "butt",
    "poop",
    "penis",
    "dik",
...
struct ProfanityFilter {
    static var MasterProfanityList: Set<String> {
